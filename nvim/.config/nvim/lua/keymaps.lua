...
vim.keymap.set('n', 'gi', function() require('telescope.builtin').lsp_implementations({ fname_width = 60 }) end)
vim.keymap.set('n', 'gr', function() require('telescope.builtin').lsp_references({ fname_width = 60 }) end)
